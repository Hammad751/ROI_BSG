...
contract Dexaglobus is Ownable{
    ...
    uint256 private constant timeStep = 30 seconds;
    ...
    mapping(address => RewardInfo1) public rewardInfo1;
    ...
    constructor(address _BUSDAddr, address _defaultRefer, address[3] memory _feeReceivers) public {
    ...
    function withdraw() external {
        ...
        RewardInfo1 storage userRewards1 = rewardInfo1[msg.sender];
    ...
    function _calCurDynamicRewards(address _user) private view returns(uint256, uint256) {
        RewardInfo storage userRewards = rewardInfo[_user];
        RewardInfo1 storage userRewards1 = rewardInfo1[_user];
        ...
        totalRewards = totalRewards.add(userRewards1.Silver).add(userRewards1.Gold).add(userRewards1.Platinum).add(userRewards1.top);
        uint256 splitAmt = totalRewards.mul(freeze2IncomePercents).div(baseDivider);
        uint256 withdrawable = totalRewards.sub(splitAmt);
        return(withdrawable, splitAmt);
    }
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 200e18 && user.teamNum >= 2 && totalTeam >= 250e18 && maxTeam >= 100e18){
                levelNow = 5;
        }
        else if(total >= 100e18){
                if(total >= 150e18 && user.teamNum >= 2 && totalTeam >= 150e18 && maxTeam >= 100e18 ){
                levelNow = 4;
                }else if(user.teamNum >= 2 && totalTeam >= 100e18 && maxTeam >= 100e18){
                levelNow = 3;
                }else{
                levelNow = 2;
                }
        ...
        //     if(total >= 2000e18 && user.teamNum >= 200 && totalTeam >= 25000e18 && maxTeam >= 10000e18 && otherTeam >= 10000e18){
        //         levelNow = 5;
        // }
        // else if(total >= 500e18){
        //         if(total >= 1000e18 && user.teamNum >= 100 && totalTeam >= 16000e18 && maxTeam >= 5000e18 && otherTeam >= 5000e18){
        //         levelNow = 4;
        //         }else if(user.teamNum >= 50 && totalTeam >= 10000e18 && maxTeam >= 1000e18 && otherTeam >= 1000e18){
        //         levelNow = 3;
        //         }else{
        //         levelNow = 2;
        //         }
    ...
    function _distributeSilverStar() private {
        ...
        if(level3Count > 0){
            ...
            for(uint256 i = 0; i < level3Users.length; i++){
                if(userInfo[level3Users[i]].level == 3){
                    rewardInfo1[level3Users[i]].Silver = rewardInfo1[level3Users[i]].Silver.add(reward);
    ...
    function _distributeGoldStar() private {
        ...
        if(level4Count > 0){
            ...
            for(uint256 i = 0; i < level4Users.length; i++){
                if(userInfo[level4Users[i]].level == 4){
                    rewardInfo1[level4Users[i]].Gold = rewardInfo1[level4Users[i]].Gold.add(reward);
    ...
    function _distributePlatinumStar() private {
        ...
        if(level5Count > 0){
            ...
            for(uint256 i = 0; i < level5Users.length; i++){
                if(userInfo[level5Users[i]].level == 5){
                    rewardInfo1[level5Users[i]].Platinum = rewardInfo1[level5Users[i]].Platinum.add(reward);
    ...
    function _distributetopPool(uint256 _dayNow) private {
        ...
        for(uint256 i = 0; i < 3; i++){
            ...
            if(userAddr != address(0)){
                ...
                rewardInfo1[userAddr].top = rewardInfo1[userAddr].top.add(reward);
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        BUSD.transfer(feeReceivers[2], fee.div(2));
